...
# a4_reg ("q0004") Region residencia ----------
ISP$q0004 <- as.factor(ISP$q0004)
ISP$a4_reg <- car::recode(ISP$q0004, recodes = c("1='Arica-Parinacota';2='Tarapaca';3='Antofagasta';4='Atacama';5='Coquimbo';6='Valparaiso'; 7='Metropolitana';8='OHiggins';9='Maule';10='Nuble';11='Biobio';12='Araucania';13='Los-Rios';14='Los-Lagos'; 15='Aysen'; 16='Magallanes'"), as.factor = T,
...
#  a5_comuna (q0005-q00020) - Comuna residencia ----------------
table(ISP$q0020)
ISP <- ISP %>% mutate(a5_comuna = case_when(q0005 == 1 ~"Arica",
                                            q0005 == 2 ~"Camarones",
                                            q0005 == 4 ~"General Lagos",
                                            q0006 == 1 ~"Iquique",
                                            q0006 == 4 ~"Huara",
                                            q0006 == 5 ~"Pica",
                                            q0006 == 6 ~"Pozo Almonte",
                                            q0006 == 7 ~"Alto Hospicio",
                                            q0007 == 1 ~"Antofagasta",
                                            q0007 == 2 ~"Mejillones",
                                            q0007 == 3 ~"Sierra Gorda",
                                            q0007 == 4 ~"Taltal",
                                            q0007 == 5 ~"Calama",
                                            q0007 == 7 ~"San Pedro de Atacama",
                                            q0007 == 8 ~"Tocopilla",
                                            q0008 == 1 ~"Copiapo",
                                            q0008 == 2 ~"Caldera",
                                            q0008 == 3 ~"Tierra Amarilla",
                                            q0008 == 4 ~"Chanaral",
                                            q0008 == 5 ~"Diego de Almagro",
                                            q0008 == 6 ~"Vallenar",
                                            q0008 == 8 ~"Freirina",
                                            q0008 == 9 ~"Huasco",
                                            q0009 == 1 ~"La Serena",
                                            ...
                                            q0010 == 6 ~ "Quilpue",
                                            q0010 == 7 ~ "Quintero",
                                            q0010 == 8 ~ "Villa Alemana",
                                            q0010 == 9 ~ "Vina del Mar",
                                            q0010 == 10 ~ "Isla de Pascua",
                                            q0010 == 11 ~ "Los Andes",
                                            q0010 == 12 ~ "Calle Larga",
                                            q0010 == 13 ~ "Rinconada",
                                            q0010 == 14 ~ "San Esteban",
                                            q0010 == 15 ~ "La Ligua",
                                            q0010 == 16 ~ "Cabildo",
                                            q0010 == 18 ~ "Petorca",
                                            q0010 == 20 ~ "Quillota",
                                            ...
                                            q0010 == 25 ~ "Nogales",
                                            q0010 == 26 ~ "Olmue",
                                            q0010 == 27 ~ "San Antonio",
                                            q0010 == 28 ~ "Algarrobo",
                                            q0010 == 29 ~ "Cartagena", 
                                            q0010 == 30 ~ "El Quisco",
                                            q0010 == 31 ~ "El Tabo",
                                            q0010 == 32 ~ "Santo Domingo", 
                                            q0010 == 33 ~ "San Felipe",
                                            q0010 == 34 ~ "Catemu",
                                            q0010 == 35 ~ "Llaillay",
                                            q0010 == 36 ~ "Panquehue",
                                            q0010 == 37 ~ "Putaendo",
                                            q0010 == 38 ~ "Santa Maria",
                                            q0011 == 1 ~ "Santiago",
                                            q0011 == 2 ~ "Cerrillos",
                                            q0011 == 3 ~ "Cerro Navia",
                                            q0011 == 4 ~ "Conchali",
                                            q0011 == 5 ~ "El Bosque",
                                            q0011 == 6 ~ "Estacion Central",
                                            q0011 == 7 ~ "Huechuraba",
                                            q0011 == 8 ~ "Independencia",
                                            q0011 == 9 ~ "La Cisterna",
                                            q0011 == 10 ~ "La Florida", 
                                            q0011 == 11 ~ "La Granja", 
                                            q0011 == 12 ~ "La Pintana",
                                            q0011 == 13 ~ "La Reina", 
                                            q0011 == 14 ~ "Las Condes", 
                                            q0011 == 15 ~ "Lo Barnechea",
                                            q0011 == 16 ~ "Lo Espejo", 
                                            q0011 == 17 ~ "Lo Prado",
                                            q0011 == 18 ~ "Macul", 
                                            q0011 == 19 ~ "Maipu", 
                                            q0011 == 20 ~ "Nunoa", 
                                            q0011 == 21 ~ "Pedro Aguirre Cerda",
                                            q0011 == 22 ~ "Penalolen", 
                                            q0011 == 23 ~ "Providencia", 
                                            q0011 == 24 ~ "Pudahuel",
                                            q0011 == 25 ~ "Quilicura", 
                                            q0011 == 26 ~ "Quinta Normal", 
                                            q0011 == 27 ~ "Recoleta", 
                                            q0011 == 28 ~ "Renca",
                                            q0011 == 29 ~ "San Joaquin", 
                                            q0011 == 30 ~ "San Miguel",
                                            q0011 == 31 ~ "San Ramon", 
                                            q0011 == 32 ~ "Vitacura",
                                            q0011 == 33 ~ "Puente Alto", 
                                            q0011 == 34 ~ "Pirque",
                                            q0011 == 35 ~ "San Jose de Maipo",
                                            q0011 == 36 ~ "Colina",
                                            q0011 == 37 ~ "Lampa",
                                            q0011 == 38 ~ "Tiltil",
                                            q0011 == 39 ~ "San Bernardo",
                                            q0011 == 40 ~ "Buin",
                                            q0011 == 41 ~ "Calera de Tango",
                                            q0011 == 42 ~ "Paine",
                                            q0011 == 43 ~ "Melipilla",
                                            q0011 == 44 ~ "Alhue",
                                            q0011 == 45 ~ "Curacavi",
                                            q0011 == 46 ~ "Maria Pinto",
                                            q0011 == 47 ~ "San Pedro",
                                            q0011 == 48 ~ "Talagante",
                                            q0011 == 49 ~ "El Monte",
                                            q0011 == 50 ~ "Isla de Maipo",
                                            q0011 == 51 ~ "Padre Hurtado",
                                            q0011 == 52 ~ "Penaflor",
                                            q0012 ==  1 ~ "Rancagua",
                                            q0012 ==  2 ~ "Codegua",
                                            q0012 ==  3 ~ "Coinco",
                                            ...
                                            q0012 ==  12 ~ "Peumo",
                                            q0012 ==  13 ~ "Pichidegua",
                                            q0012 ==  14 ~ "Quinta de Tilcoco",
                                            q0012 ==  15 ~ "Rengo",
                                            q0012 ==  16 ~ "Requinoa",
                                            q0012 ==  17 ~ "San Vicente",
                                            q0012 ==  18 ~ "Pichilemu",
                                            q0012 ==  21 ~ "Marchihue",
                                            q0012 ==  22 ~ "Navidad",
                                            q0012 ==  24 ~ "San Fernando",
                                            q0012 ==  25 ~ "Chepica",
                                            q0012 ==  26 ~ "Chimbarongo",
                                            q0012 ==  27 ~ "Lolol",
                                            q0012 ==  28 ~ "Nancagua",
                                            q0012 ==  29 ~ "Palmilla",
                                            q0012 ==  30 ~ "Peralillo",
                                            ...
                                            q0013 ==  27 ~ "Retiro",
                                            q0013 ==  28 ~ "San Javier",
                                            q0013 ==  29 ~ "Villa Alegre",
                                            q0013 ==  30 ~ "Yerbas Buenas",
                                            q0014 ==  1 ~ "Concepcion",
                                            q0014 ==  2 ~ "Coronel",
                                            q0014 ==  3 ~ "Chiguayante",
                                            q0014 ==  4 ~ "Florida",
                                            ...
                                            q0014 ==  14 ~ "Arauco",
                                            q0014 ==  15 ~ "Canete",
                                            q0014 ==  17 ~ "Curanilahue",
                                            q0014 ==  18 ~ "Los Alamos",
                                            q0014 ==  19 ~ "Tirua",
                                            q0014 ==  20 ~ "Los Angeles",
                                            q0014 ==  22 ~ "Cabrero",
                                            q0014 ==  23 ~ "Laja",
                                            q0014 ==  24 ~ "Mulchen",
                                            q0014 ==  25 ~ "Nacimiento",
                                            q0014 ==  26 ~ "Negrete",
                                            q0014 ==  28 ~ "Quilleco",
                                            q0014 ==  29 ~ "San Rosendo",
                                            q0014 ==  30 ~ "Santa Barbara",
                                            q0014 ==  32 ~ "Yumbel",
                                            q0014 ==  39 ~ "Portezuelo",
                                            q0014 ==  42 ~ "San Fabian",
                                            q0014 ==  43 ~ "San Nicolas",
                                            q0014 ==  45 ~ "Treguaco",
                                            q0015 ==  1 ~ "Chillan",
                                            q0015 ==  2 ~ "San Carlos",
                                            q0015 ==  3 ~ "Coihueco",
                                            ...
                                            q0016 ==  8 ~ "Lautaro",
                                            q0016 ==  9 ~ "Loncoche",
                                            q0016 ==  11 ~ "Nueva Imperial",
                                            q0016 ==  12 ~ "Padre Las Casas",
                                            q0016 ==  13 ~ "Perquenco",
                                            q0016 ==  14 ~ "Pitrufquen",
                                            q0016 ==  15 ~ "Pucon",
                                            q0016 ==  16 ~ "Saavedra",
                                            q0016 ==  17 ~ "Teodoro Schmidt",
                                            q0016 ==  18 ~ "Tolten",
                                            q0016 ==  19 ~ "Vilcun",
                                            q0016 ==  20 ~ "Villarrica",
                                            q0016 ==  21 ~ "Cholchol",
                                            ...
                                            q0018 ==  10 ~ "Quinchao",
                                            q0018 ==  11 ~ "Llanquihue",
                                            q0018 ==  12 ~ "Puerto Montt",
                                            q0018 ==  13 ~ "Calbuco",
                                            q0018 ==  14 ~ "Cochamo",
                                            q0018 ==  15 ~ "Fresia",
                                            q0018 ==  16 ~ "Frutillar",
                                            q0018 ==  17 ~ "Los Muermos",
                                            q0018 ==  18 ~ "Maullin",
                                            q0018 ==  19 ~ "Puerto Varas",
                                            q0018 ==  20 ~ "Osorno",
                                            q0018 ==  21 ~ "Puerto Octay",
                                            q0018 ==  22 ~ "Purranque",
                                            q0018 ==  23 ~ "Puyehue",
                                            q0018 ==  24 ~ "Rio Negro",
                                            q0018 ==  25 ~ "San Juan de la Costa",
                                            q0018 ==  26 ~ "San Pablo",
                                            q0018 ==  28 ~ "Chaiten",
                                            q0018 ==  29 ~ "Futaleufu",
                                            q0018 ==  30 ~ "Hualaihue",
                                            ...
                                            q0019 ==  8 ~ "Tortel",
                                            q0019 ==  9 ~ "Chile Chico",
                                            q0020 ==  1 ~ "Punta Arenas",
                                            q0020 ==  5 ~ "Cabo de Horno",
                                            q0020 ==  7 ~ "Porvenir",
                                            q0020 ==  8 ~ "Primavera",
                                            q0020 ==  9 ~ "Timaukel",
                                            q0020 ==  10 ~ "Natales "))
