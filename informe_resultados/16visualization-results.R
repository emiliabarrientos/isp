...
# 3. Filtros
isp <- isp %>%  filter(a1_sexo !="Otro", b1 == "SII")
...
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico0.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 2. Graficar
ggplot(mod, aes(x = a1_sexo, y = p*100 , fill = mod)) +
  geom_bar(stat = "identity", color = "black")  + 
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico1.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico2.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico4.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico5.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 30,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico6.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 30,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico7.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 30,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico8.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico9.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico10.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico11.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico12.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico14.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 30,
...
# 2. Grafico  15
plot_stackfrq(le[,c(9:13)], geom.colors = "Reds", show.total = F,weight.by = isp$pond2) +
  labs(caption = "Fuente: Elaboración propia en base a ISP (2020)") + theme(legend.position = "bottom") 


#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico15.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 35,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico16.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 23,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico17.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 30,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico18.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 35,
...
# Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico19-general.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 20,
...
ggsave(plot = lf,
       filename = "informe_resultados/images_sii/grafico19.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 30,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico20-simple.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 20,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico20.1.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 2. Grafico  20.1
plot_stackfrq(lerps[,c(4,7,6,5,8)], geom.colors = "Reds", show.total = F,weight.by = isp$pond2) +
  labs(caption = "Fuente: Elaboración propia en base a ISP (2020)") + theme(legend.position = "bottom") 

#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico20.2.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
#3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico20.3.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico21.1.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico21.2.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico21.3.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 35,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico21.4.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico22.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico23.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 20,
...
# Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico24-general.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 30,
...
ggsave(plot = lg,
       filename = "informe_resultados/images_sii/grafico24.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 20,
...
# Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico25.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico26.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico28.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = d,
       filename = "informe_resultados/images_sii/grafico29.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
...
# 3. Guardar
ggsave(plot = last_plot(),
       filename = "informe_resultados/images_sii/grafico29-opcionB.png",
       device = "png",
       dpi = "retina",
       units = "cm",
       width = 25,
